        ...
        <div className="bg-spotify-lightgray rounded-lg p-8 shadow-2xl">
          ...
          >
            <Button
              ...
              className="w-full bg-primary flex hover:bg-primary/90 text-white font-semibold py-3 px-6 rounded-full transition-all duration-200 transform hover:scale-105"
              size="lg"
            >
